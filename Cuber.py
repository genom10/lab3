...
def main():
    ...
    # Declare the output queue for cubed numbers
    ...
    def callback(ch, method, properties, body):
        try:
            ...
            message = json.dumps({'sender':sender, 'operation':'cubed', 'number':cubed})
            # Publish the cubed result to the output queue
            ...
            print(f" [x] Processed {number} -> {cubed} from {sender}")
